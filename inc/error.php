...
<head>
	...
	<meta name="description" content="GARD Realms WOTLK 3.3.5a 2 Realms PVP/PVE High Stats , play for fun!">
	<meta name="keywords" content="Gaming,GARD Realms,3.3.5a,5.4.8,6.2.2,GARDrealms,WoW,WOTLK,Warlords of Draenor,MOP,WoD,255,level,server,GARDrealms.com,GARDrealms.com,GARDrealms.info,free servers,Warlords of Draenor private server,free wow server,wow forum,mmorpg server,80 instant,PVP,PVE,255 level,largest server, custom, instances, cuztom zones, events, quality server, quality server,">
	...
	<title>GARD Realms - <?php echo ucwords( str_ireplace(array('-', '.php'), array(' ', ''), basename($_SERVER['PHP_SELF']) ) )?></title>
</head>
<body>
<div id='content'>
	<div id='header'>
